...
public class Distance {
    ...
    //in java math library ,it takes triognometric functions by default as radians.so we use  Math.toRadians to convert degrees to radians to get the values correct
